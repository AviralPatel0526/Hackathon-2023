...
function Section4() {
  return (
    <div className='h-[130vh] dark:bg-primary bg-cover bg-center flex flex-col  items-center gap-28' style={{ backgroundImage: `url(${section41})` }}>
     ...
     <p className='text-[50px] font-bold'>Globe.</p>
      ...
      <div className='flex justify-center gap-8  w-full items-center overflow-x-hidde '>
         <div className='hidden md:block w-[300px] h-[300px] bg-blue-500 shadow-lg shadow-blue-800'>
         ...
         <div className='w-[300px] h-[300px] bg-white shadow-lg shadow-black'>
         ...
         <div className='hidden md:block w-[300px] h-[300px] bg-white shadow-lg shadow-black'>
         <div className='flex flex-col gap-2 h-[100%] justify-center pl-4 text-gray-400 w-[280px]'>
